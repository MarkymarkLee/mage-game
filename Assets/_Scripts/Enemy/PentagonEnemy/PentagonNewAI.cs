...
public class PentagonNewAI : MonoBehaviour{
    ...
    {
        // GameObject beamObject = Instantiate(beamPrefab, start, Quaternion.identity);
    ...
    private void SpawnDonutAoe(Vector3 position, Quaternion angle)
    {
        ...
        DonutAoe donutAoe = donutAoeObject.GetComponent<DonutAoe>();
    }
