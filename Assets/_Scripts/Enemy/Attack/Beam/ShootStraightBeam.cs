...
public class ShootStraightBeam : MonoBehaviour
{
    ...
    {
        Vector3 endPoint = direction;
        // endPoint = CalculateBeamEndPoint(start, direction);
        beamSpawner.SpawnBeam(start, endPoint, beamSpawner.beamWidth * 3.0f, activeTime, delayBeforeDamage, false);
    }
    ...
    private Vector3 CalculateBeamEndPoint(Vector3 startPoint, Vector3 direction)
    {
        ...
        return startPoint + direction * Mathf.Max(screenBounds.x, screenBounds.y) * 3.0f;
    }
}